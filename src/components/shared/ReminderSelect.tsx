    ...
    return(
      <FormField label={t(`${label}`)}>
        <div className="relative" >
          ...
          <Icon className={`absolute top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none ${
              isRTL ? "right-3" : "left-3"
          }`} size={16} />
          <IoIosArrowDown className={`absolute top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none ${
